...
struct SymbolExIcons(SymbolEx symbolEx)
{
    public SymbolEx SymbolEx { get; set; } = symbolEx;
    public static implicit operator SymbolIcon(SymbolExIcons @this) => new((Symbol)@this.SymbolEx);
    public SymbolIcon Build() => this;
}
